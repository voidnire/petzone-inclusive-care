    ...
    <Card className="border-2 border-pet-green">
      <CardHeader>
        <CardTitle className="flex items-center space-x-2 text-pet-green">
          ...
          <Badge variant="outline" className="text-xs">Acessibilidade</Badge>
        </CardTitle>
      </CardHeader>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="flex space-x-2">
          <Button
            ...
            className={`flex-1 ${isListening ? 'bg-red-500 hover:bg-red-600' : 'bg-pet-green hover:bg-green-600'}`}
          >
        ...
        {lastCommand && (
          <div className="bg-slate-50 border border-slate-200 rounded-lg p-3">
            <div className="text-sm">
              ...
              <div className="text-pet-blue mt-1">"{lastCommand}"</div>
            </div>
          </div>
        )}

        <div>
          <h4 className="text-sm font-medium text-slate-700 mb-2">Comandos disponíveis:</h4>
